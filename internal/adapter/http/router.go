...
func NewRouter(handler *Handler, authClient *auth.Client, corsOrigins []string) *echo.Echo {
	...
	protected.GET("/products/:id/categories", handler.ListProductCategories, catalogRead)
	...
	protected.GET("/products/:id/images", handler.ListProductImages, catalogRead)
	...
	protected.GET("/inventory/reservations", handler.ListReservations, inventoryRead)
